...
public class AgentsRepo extends IdRepo implements ServiceListener {
    ...
    public boolean authenticate(Callback[] credentials) 
        ...
        try {
            ...
            if ((userPwdSet != null) && (!userPwdSet.isEmpty())) {
                ...
                if (!(answer = password.equals(userPwd)) && !(answer = oAuth2ClientSpecialCase(ansMap, unhashedPassword, userPwd))) {
    ...
    private boolean oAuth2ClientSpecialCase(Map attributeMap, String unhashedPassword, String userPassword) {
