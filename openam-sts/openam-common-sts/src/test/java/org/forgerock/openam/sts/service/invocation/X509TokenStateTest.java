...
public class X509TokenStateTest {
    private static final String X_509 = "X.509";

    @Test
    public void testJsonRoundTrip() throws Exception {
        X509TokenState x509TokenState = X509TokenState.builder().x509Certificate(getCertificate()).build();
        assertEquals(x509TokenState, X509TokenState.fromJson(x509TokenState.toJson()));
    }
