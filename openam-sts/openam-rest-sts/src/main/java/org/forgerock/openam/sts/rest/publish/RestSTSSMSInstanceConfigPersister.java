...
public class RestSTSSMSInstanceConfigPersister implements STSInstanceConfigPersister<RestSTSInstanceConfig> {
    ...
    @Inject
    RestSTSSMSInstanceConfigPersister(MapMarshaller<RestSTSInstanceConfig> instanceConfigMapMarshaller) {
    ...
    public void persistSTSInstance(String key, RestSTSInstanceConfig instance) throws STSInitializationException {
        ...
        try {
            ...
            organizationConfigManager.addServiceConfig(SERVICE_NAME, instanceConfigAttributes);
        } catch (SMSException e) {
            throw new STSInitializationException(ResourceException.INTERNAL_ERROR,
                    "Exception caught initializing SMS context necessary to persist RestSTSInstanceConfig instance: " + e, e);
        }
    }
