...
public class RestSTSInstanceStateProvider implements STSInstanceStateProvider<RestSTSInstanceState> {
    ...
    public RestSTSInstanceState getSTSInstanceState(String instanceId, String realm) throws TokenCreationException, STSInitializationException {
    ...
    private RestSTSInstanceState createSTSInstanceState(String instanceId, String realm) throws TokenCreationException, STSInitializationException {
