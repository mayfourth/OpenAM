...
public final class ApplicationManager {
    ...
    public static void updateApplication(Application oldApplication, Application newApplication, Subject subject,
        ...
        if (oldApplication.getName().equals(newApplication.getName())) {
            throw new EntitlementException(EntitlementException.APPLICATION_NAMES_ERROR);
        }

        readWriteLock.writeLock().lock();

        try {
            deleteApplication(subject, realm, newApplication.getName());
